...
<table border=0><tr>
  <td> <img src="images/calcium.jpg" alt="Calcium" class="inline" height=25% width=25% display=block/> </td>
  <td> <img src="images/carbonate.jpg" alt="Carbonate" class="inline" height=25% width=25% display=block/> </td>
</tr><table>
### Initial Approaches
